...
<div class="page-header animate-fade-in">
    <div><h1 class="page-title">Edit Template</h1><p class="page-subtitle">Ubah template resep</p></div>
</div>
        ...
        <div class="section-card animate-fade-in">
            <form action="{{ route('admin.template-resep.update', $template->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="2">{{ $template->deskripsi }}</textarea>
                </div>
                <div class="mb-4">
