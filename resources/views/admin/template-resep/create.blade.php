...
<div class="row mb-4">
    <div class="col-md-12">
        <h4 class="mb-3">Tambah Template Resep Baru</h4>
    </div>
</div>
                        ...
                        <div class="medicine-item mb-3 p-3 border rounded">
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input type="text" name="items[0][nama_obat]" class="form-control" required>
                                </div>
                                <div class="col-md-2 mb-2">
                                    <label class="form-label">Dosis</label>
                                    <input type="text" name="items[0][dosis]" class="form-control" placeholder="mis: 500mg" required>
                                </div>
                                <div class="col-md-2 mb-2">
                                    <label class="form-label">Frekuensi</label>
                                    <input type="text" name="items[0][frekuensi]" class="form-control" placeholder="mis: 3x1" required>
                                </div>
                                <div class="col-md-2 mb-2">
                                    <label class="form-label">Durasi</label>
                                    <input type="text" name="items[0][durasi]" class="form-control" placeholder="mis: 7 hari" required>
                                </div>
                                <div class="col-md-2 mb-2">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="items[0][instruksi]" class="form-control" placeholder="mis: diminum setelah makan">
                                </div>
                            </div>
                        </div>
                    </div>
